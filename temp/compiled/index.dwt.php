...
<meta name="Generator" content="选礼品 xuanlp.com ">
...
<link rel="icon" href="http://www.quwan.com/animated_favicon.gif" type="image/gif">
<link rel="shortcut icon" href="favicon.ico" />
...
<div class="right" id="flashright">
  <dl class="rush">
  	<dt>本周特价</td>
	<dd>
		<img src="themes/default/images/promotion/promotion-07112011.jpg" style="height:341px;width:260px;"/>
	</dd>
  </dl>
  <dl class="notice">
    <dt></dt>
...
?>
      	<dd style="border:none;">[<a href="<?php echo $this->_var['article']['cat_url']; ?>"><?php echo $this->_var['article']['cat_name']; ?></a>]<a href="<?php echo $this->_var['article']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['article']['title']); ?>"><?php echo sub_str($this->_var['article']['short_title'],12); ?></a></dd>
...
<div class="left"> 
  ...
  <div class="new">
    ...
    <div id="nbox">
      <div style="display: none;" class="nbox_in switch_item"> 
...
?>
				<ul class="new_ul">
				  <li class="new_img"> <a href="<?php echo $this->_var['goods']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>" target="_blank"><img src="<?php echo $this->_var['goods']['thumb']; ?>" alt="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>" height="130" width="130"></a> 
				  </li>
				  <li><a href="<?php echo $this->_var['goods']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>" target="_blank"><?php echo htmlspecialchars(sub_str($this->_var['goods']['name'],10)); ?></a></li>
				  <?php if ($this->_var['goods']['promote_price'] != ""): ?>
				  <li><span><?php echo $this->_var['goods']['promote_price']; ?></span></li>
				  <?php else: ?>
				  <li><span><?php echo $this->_var['goods']['shop_price']; ?></span></li>
				  <?php endif; ?>
				</ul>
			<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
		<?php endif; ?>
      ...
      <div class="switch_item current-li" style="display: block;"> 
...
?>
	<?php if ($this->_foreach['top_goods']['iteration'] < 2): ?>
     <dd> 
	  <ul class="rank_on" style="display:block;">
      <li class="rank_img"><span class="rank_span rank_spanon"><?php echo $this->_foreach['top_goods']['iteration']; ?></span> <a href="<?php echo $this->_var['goods']['url']; ?>" target="_blank" title="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>"> <img src="<?php echo $this->_var['goods']['thumb']; ?>" alt="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>" height="100" width="100"> </a> </li>
      <li class="rankon_name"><a href="<?php echo $this->_var['goods']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>" target="_blank"><?php echo $this->_var['goods']['short_name']; ?></a></li>
      <li><font>¥<?php echo $this->_var['goods']['shop_price']; ?></font></li>
      </ul>
      <ul class="rank_off rank_odd" style="display:none;">
      <li class="rank_name"><span class="rank_span"><?php echo $this->_foreach['top_goods']['iteration']; ?></span><a href="" title="" target="_blank"><?php echo $this->_var['goods']['short_name']; ?></a></li>
      </ul>
    </dd>
	<?php else: ?>
    <dd> <ul class="rank_on">
      ...
      <ul class="rank_off ">
      <li class="rank_name"><span class="rank_span"><?php echo $this->_foreach['top_goods']['iteration']; ?></span><a href="<?php echo $this->_var['goods']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>" target="_blank"><?php echo htmlspecialchars($this->_var['goods']['short_name']); ?></a></li>
      </ul>
    </dd>
	<?php endif; ?>
	<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
