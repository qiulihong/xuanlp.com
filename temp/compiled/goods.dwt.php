  ...
  <div class="AreaR">
   ...
   <div id="goodsInfo" class="clearfix">
     ...
     <?php echo $this->fetch('library/goods_gallery.lbi'); ?>
         ...
         <div class="blank5"></div>
         <div>
		      <a href="javascript:collect(<?php echo $this->_var['goods']['goods_id']; ?>)" class="collect"></a>
		      <?php if ($this->_var['affiliate']['on']): ?>
		      <a href="user.php?act=affiliate&goodsid=<?php echo $this->_var['goods']['goods_id']; ?>" class="share"></a>
		      <?php endif; ?>
         </div>
...
?>
      ...
      <li class="clearfix">
       ...
       <?php echo $this->_var['lang']['shop_price']; ?><font class="sell" id="ECS_SHOPPRICE"><?php echo $this->_var['goods']['shop_price_formated']; ?></font><br />
       <!--
...
?>
       <?php echo $this->_var['rank_price']['rank_name']; ?>：<font class="shop" id="ECS_RANKPRICE_<?php echo $this->_var['key']; ?>"><?php echo $this->_var['rank_price']['price']; ?></font><br />
       <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
       //-->
       </dd>
       <dd style="width:48%; padding-left:7px;height:60px;">
       <?php echo $this->_var['lang']['goods_rank']; ?>
...
?>
      ...
      <div class="padd" style="padding:10px;background:ccc;border:1px solid #FFE2A6;height:120px;color:#666666;background:#FFF4EB;">
	      <div style="margin-bottom:30px;">
	       ...
	       <?php echo $this->_var['lang']['goods_integral']; ?><font class="f4"><?php echo $this->_var['goods']['integral']; ?> <?php echo $this->_var['points_name']; ?></font>
	       <?php endif; ?>
	       </dd>
	      </div>
      <a href="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>)" class="add_to_cart_btn"></a>
      </div>
      </form>
     </div>
   </div>
...
?>
        <?php echo $this->_var['package_goods']['act_name']; ?><br />
        <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#dddddd">
        <tr>
        <td bgcolor="#FFFFFF">
...
?>
          ...
          <?php echo $this->_var['lang']['package_price']; ?><font class="shop"><?php echo $this->_var['package_goods']['package_price']; ?></font><br />
          <?php echo $this->_var['lang']['then_old_price']; ?><font class="shop"><?php echo $this->_var['package_goods']['saving']; ?></font><br />
          </td>
          <td bgcolor="#FFFFFF">
