...
<title>果色生香系列多用途闹钟—西瓜-25229_创意礼品_选礼品 - 专业礼品选购平台: 家居 小家电 粮油土特产 创意工艺品 办公用品</title>
...
<div class="block" style="border-bottom:1px solid #CB3F3F;">
 <div id="ur_here">
  <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=16">创意礼品</a> <code>&gt;</code> 果色生香系列多用途闹钟—西瓜-25229 </div>
</div>
<div class="blank"></div>
...
document.getElementById('history_list').innerHTML = '您已清空最近浏览过的商品';
  ...
  <div class="AreaR">
   ...
   <div id="goodsInfo" class="clearfix">
     ...
     <div class="imgInfo">
          <a href="javascript:;" onclick="window.open('gallery.php?id=121'); return false;">
      <img src="images/201111/goods_img/121_G_1320274082083.jpg" alt="果色生香系列多用途闹钟—西瓜-25229"/>
     </a>
              <div class="blank5"></div>
      ...
      <div class="gallery">
        <div id="demo">
          <div id="demo1" style="float:left">
            <ul>
                         <li><a href="gallery.php?id=121&amp;img=150" target="_blank"><img src="images/201111/thumb_img/121_thumb_P_1320274082597.jpg" alt="果色生香系列多用途闹钟—西瓜-25229" class="B_blue" /></a>
            </li>
                        </ul>
          </div>
      ...
      function clickRight() {
         ...
         <div class="blank5"></div>
         <div>
		      <a href="javascript:collect(121)" class="collect"></a>
		      		      <a href="user.php?act=affiliate&goodsid=121" class="share"></a>
		               </div>
     ...
     <div class="clearfix">
      <p class="f_l">果色生香系列多用途闹钟—西瓜-25229</p>
      <p class="f_r">
            <a href="goods.php?id=122"><img alt="prev" src="themes/default/images/up.gif" /></a>
                  <a href="goods.php?id=120"><img alt="next" src="themes/default/images/down.gif" /></a>
            </p>
      </div>
      <ul>
             <li class="clearfix">
       <dd>
              商品货号：XLP000121              </dd>
       <dd>
              商品品牌：<a href="brand.php?id=23" >爱彼此</a>
              </dd>
      </li>
      <!--li class="clearfix">
       <dd class="ddR">
      ...
      <li class="clearfix">
       <dd class="">
              市场价格：<font class="market">￥55元</font><br />
              
       本店售价：<font class="sell" id="ECS_SHOPPRICE">￥46元</font><br />
       <!--
              注册用户：<font class="shop" id="ECS_RANKPRICE_1">￥46元</font><br />
              vip：<font class="shop" id="ECS_RANKPRICE_2">￥44元</font><br />
              //-->
       </dd>
      ...
      <a href="javascript:addToCart(121)" class="add_to_cart_btn"></a>
      </div>
      </form>
     </div>
   </div>
   <div class="blank"></div>
     ...
     <div class="box_1">
      ...
      <div id="com_h">
       <blockquote>
        <p>产品尺寸：直径9cm包装尺寸：10cm*10cm*5cm材质：塑料外壳,跳秒机芯<br />
1.请及时更换长期使用的电池，避免电池氧化液流出损坏机芯；<br />
2.清洁表面时，请使用软布擦拭，切勿使用化学助剂；<br />
3.请转动中部背面的调时旋钮来调整时间；<br />
4.应远离高温、高湿、强磁场、多灰尘等环境。</p>
<p>趣味水果元素，实用的磁铁功能，点缀你的厨房，让下厨不再是苦恼的事！</p>       </blockquote>
     <blockquote>
...
<script type="text/javascript" src="js/transport.js"></script><script type="text/javascript" src="js/utils.js"></script><div id="ECS_BOUGHT">554fcae493e564ee0dc75bdf2ebf94cabought_notes|a:2:{s:4:"name";s:12:"bought_notes";s:2:"id";i:121;}554fcae493e564ee0dc75bdf2ebf94ca</div>
  </div>
