...
<title>HT117_数码小家电_选礼品 - 专业礼品选购平台: 家居 小家电 粮油土特产 创意工艺品 办公用品</title>
...
<div class="block" style="border-bottom:1px solid #CB3F3F;">
 <div id="ur_here">
  <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=12">数码小家电</a> <code>&gt;</code> HT117 </div>
</div>
<div class="blank"></div>
...
document.getElementById('history_list').innerHTML = '您已清空最近浏览过的商品';
  ...
  <div class="AreaR">
   ...
   <div id="goodsInfo" class="clearfix">
     ...
     <div class="imgInfo">
          <a href="javascript:;" onclick="window.open('gallery.php?id=40'); return false;">
      <img src="images/201110/goods_img/40_G_1319637987696.jpg" alt="HT117"/>
     </a>
              <div class="blank5"></div>
      ...
      <div class="gallery">
        <div id="demo">
          <div id="demo1" style="float:left">
            <ul>
                         <li><a href="gallery.php?id=40&amp;img=51" target="_blank"><img src="images/201110/thumb_img/40_thumb_P_1319637997041.jpg" alt="HT117" class="B_blue" /></a>
            </li>
                        </ul>
          </div>
      ...
      function clickRight() {
         ...
         <div class="blank5"></div>
         <div>
		      <a href="javascript:collect(40)" class="collect"></a>
		      		      <a href="user.php?act=affiliate&goodsid=40" class="share"></a>
		               </div>
     ...
     <div class="clearfix">
      <p class="f_l">HT117</p>
      <p class="f_r">
            <a href="goods.php?id=41"><img alt="prev" src="themes/default/images/up.gif" /></a>
                  <a href="goods.php?id=39"><img alt="next" src="themes/default/images/down.gif" /></a>
            </p>
      </div>
      <ul>
             <li class="clearfix">
      ...
      <li class="clearfix">
       <dd class="">
              市场价格：<font class="market">￥264元</font><br />
              
       本店售价：<font class="sell" id="ECS_SHOPPRICE">￥220元</font><br />
       <!--
              注册用户：<font class="shop" id="ECS_RANKPRICE_1">￥220元</font><br />
              vip：<font class="shop" id="ECS_RANKPRICE_2">￥209元</font><br />
              //-->
       </dd>
      ...
      <a href="javascript:addToCart(40)" class="add_to_cart_btn"></a>
      </div>
      </form>
     </div>
   </div>
...
<script type="text/javascript" src="js/transport.js"></script><script type="text/javascript" src="js/utils.js"></script><div id="ECS_BOUGHT">554fcae493e564ee0dc75bdf2ebf94cabought_notes|a:2:{s:4:"name";s:12:"bought_notes";s:2:"id";i:40;}554fcae493e564ee0dc75bdf2ebf94ca</div>
  </div>
