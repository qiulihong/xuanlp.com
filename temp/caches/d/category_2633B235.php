...
document.getElementById('history_list').innerHTML = '您已清空最近浏览过的商品';
		 ...
		 <div class="box_1">
			...
			<strong>价格：</strong>
											<a href="category.php?id=1&amp;price_min=0&amp;price_max=0">全部</a>&nbsp;
															...
															<a href="category.php?id=1&amp;price_min=200&amp;price_max=220">200&nbsp;-&nbsp;220</a>&nbsp;
															<span>220&nbsp;-&nbsp;240</span>
										</div>
								 </div>
		</div>
 ...
 <div class="box_1">
  ...
  <a href="category.php?category=1&display=grid&brand=0&price_min=220&price_max=240&filter_attr=0&page=1&sort=goods_id&order=DESC#goods_list"><img src="themes/default/images/goods_id_default.gif" alt="按上架时间排序"></a>
  <a href="category.php?category=1&display=grid&brand=0&price_min=220&price_max=240&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list"><img src="themes/default/images/shop_price_DESC.gif" alt="按价格排序"></a>
  <a href="category.php?category=1&display=grid&brand=0&price_min=220&price_max=240&filter_attr=0&page=1&sort=last_update&order=DESC#goods_list"><img src="themes/default/images/last_update_default.gif" alt="按更新时间排序"></a>
  <input type="hidden" name="category" value="1" />
  <input type="hidden" name="display" value="grid" id="display" />
  <input type="hidden" name="brand" value="0" />
  <input type="hidden" name="price_min" value="220" />
  ...
  <input type="hidden" name="order" value="DESC" />
    ...
    <div class="clearfix goodsBox" style="border:none;">
             <div class="goodsItem">
           <a href="goods.php?id=88"><img src="images/201110/thumb_img/88_thumb_G_1319686238659.jpg" alt="怡雅礼盒B（1..." class="goodsimg" /></a><br />
           <p><a href="goods.php?id=88" title="怡雅礼盒B（1瓶特）">怡雅礼盒B（1...</a></p>
                       市场价<font class="market_s">￥274元</font><br />
                                    本店价<font class="shop_s">￥228元</font><br />
                       <!--a href="javascript:collect(88);" class="f6">收藏</a> |
           <a href="javascript:addToCart(88)" class="f6">购买</a> |
           <a href="javascript:;" id="compareLink" onClick="Compare.add(88,'怡雅礼盒B（1...','0')" class="f6">比较</a-->
        </div>
                    </div>
    </div>
        </form>
