...
<title>荣事达 豆浆机 RD－800G_数码小家电_选礼品 - 专业礼品选购平台: 家居 小家电 粮油土特产 创意工艺品 办公用品</title>
  ...
  <div id="nav">
    <ul class="nav_item">
	  <li class="nav_li"><a href="index.php" class="nav_a" >首页<span></span></a></li>
	 	  ...
	 	  <li class="nav_li"><a href="category.php?id=12"   class="index_a indexon_a"  onmouseover="$('.nav_a').removeClass('on');$(this).addClass('on');$('.nav_pop').hide();$(this).parent().find('.nav_pop').show();">数码小家电</a></li>
...
<div class="block" style="border-bottom:1px solid #CB3F3F;">
 <div id="ur_here">
  <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=12">数码小家电</a> <code>&gt;</code> 荣事达 豆浆机 RD－800G </div>
</div>
<div class="blank"></div>
  ...
  <div class="AreaR">
   ...
   <div id="goodsInfo" class="clearfix">
     ...
     <div class="imgInfo">
      ...
      <img src="images/201110/goods_img/53_G_1319637990213.jpg" alt="荣事达 豆浆机 RD－800G"/>
     </a>
              <div class="blank5"></div>
      ...
      <div class="gallery">
        <div id="demo">
          <div id="demo1" style="float:left">
            <ul>
                         <li><a href="gallery.php?id=53&amp;img=68" target="_blank"><img src="images/201110/thumb_img/53_thumb_P_1319637995322.jpg" alt="荣事达 豆浆机 RD－800G" class="B_blue" /></a>
            </li>
                        </ul>
          </div>
      ...
      function clickRight() {
         ...
         <div class="blank5"></div>
         <div>
		      <a href="javascript:collect(53)" class="collect"></a>
		      		      <a href="user.php?act=affiliate&goodsid=53" class="share"></a>
		               </div>
     ...
     <div class="clearfix">
      <p class="f_l">荣事达 豆浆机 RD－800G</p>
      <p class="f_r">
            <a href="goods.php?id=54"><img alt="prev" src="themes/default/images/up.gif" /></a>
                  <a href="goods.php?id=52"><img alt="next" src="themes/default/images/down.gif" /></a>
            </p>
      </div>
      <ul>
             <li class="clearfix">
       <dd>
              商品货号：XLP000053              </dd>
       <dd>
              商品品牌：<a href="brand.php?id=12" >荣事达</a>
              </dd>
      </li>
      <!--li class="clearfix">
       <dd class="ddR">
      ...
      <li class="clearfix">
       ...
       本店售价：<font class="sell" id="ECS_SHOPPRICE">￥399元</font><br />
       <!--
              注册用户：<font class="shop" id="ECS_RANKPRICE_1">￥399元</font><br />
              vip：<font class="shop" id="ECS_RANKPRICE_2">￥379元</font><br />
              //-->
       </dd>
      ...
      <a href="javascript:addToCart(53)" class="add_to_cart_btn"></a>
      </div>
      </form>
     </div>
   </div>
     ...
     <div class="box_1">
      ...
      <div id="com_h">
       <blockquote>
        <p>1、无网<br />
2、杯体：不锈钢杯体,一体成型<br />
3、加热功率：800W&nbsp;&nbsp; 容积：1.6L<br />
彩箱:220*220*345mm外箱: 675*450*365mm</p>
<p>1、五谷豆浆、营养米糊、果汁豆沙等可轻松制作；<br />
2、花样豆浆、特色米糊，价格低廉，随意搭配，满足各种人群健康需求；<br />
3、特别突出独创智频温控技术，模拟&ldquo;大火加热、中火催熟、文火熬煮&rdquo;三段式传统熬煮工艺，严格检测每个温度点，煮浆、打料交替实现，保证豆浆米糊充分煮熟熬透，营养更丰富，更易人体吸收；<br />
4、突出紊流技术，讲力学原理，出浆更快，研磨加倍细微；<br />
5、双探头、刀片、杯体等材质特点</p>       </blockquote>
     <blockquote>
...
<script type="text/javascript" src="js/transport.js"></script><script type="text/javascript" src="js/utils.js"></script><div id="ECS_BOUGHT">554fcae493e564ee0dc75bdf2ebf94cabought_notes|a:2:{s:4:"name";s:12:"bought_notes";s:2:"id";i:53;}554fcae493e564ee0dc75bdf2ebf94ca</div>
  </div>
