...
document.getElementById('history_list').innerHTML = '您已清空最近浏览过的商品';
 ...
 <div class="box_1">
  ...
  <a href="category.php?category=1&display=grid&brand=10&price_min=120&price_max=140&filter_attr=0&page=1&sort=goods_id&order=DESC#goods_list"><img src="themes/default/images/goods_id_ASC.gif" alt="按上架时间排序"></a>
