...
<title>竹质声控LED桌面钟-长方体-19894_创意礼品_选礼品 - 专业礼品选购平台: 家居 小家电 粮油土特产 创意工艺品 办公用品</title>
...
<div class="block" style="border-bottom:1px solid #CB3F3F;">
 <div id="ur_here">
  <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=16">创意礼品</a> <code>&gt;</code> 竹质声控LED桌面钟-长方体-19894 </div>
</div>
<div class="blank"></div>
...
document.getElementById('history_list').innerHTML = '您已清空最近浏览过的商品';
  ...
  <div class="AreaR">
   ...
   <div id="goodsInfo" class="clearfix">
     ...
     <div class="imgInfo">
          <a href="javascript:;" onclick="window.open('gallery.php?id=126'); return false;">
      <img src="images/201111/goods_img/126_G_1320274691140.jpg" alt="竹质声控LED桌面钟-长方体-19894"/>
     </a>
              <div class="blank5"></div>
      ...
      <div class="gallery">
        <div id="demo">
          <div id="demo1" style="float:left">
            <ul>
                         <li><a href="gallery.php?id=126&amp;img=155" target="_blank"><img src="images/201111/thumb_img/126_thumb_P_1320274691490.jpg" alt="竹质声控LED桌面钟-长方体-19894" class="B_blue" /></a>
            </li>
                        </ul>
          </div>
      ...
      function clickRight() {
         ...
         <div class="blank5"></div>
         <div>
		      <a href="javascript:collect(126)" class="collect"></a>
		      		      <a href="user.php?act=affiliate&goodsid=126" class="share"></a>
		               </div>
     ...
     <div class="clearfix">
      <p class="f_l">竹质声控LED桌面钟-长方体-19894</p>
      <p class="f_r">
                  <a href="goods.php?id=125"><img alt="next" src="themes/default/images/down.gif" /></a>
            </p>
      </div>
      <ul>
             <li class="clearfix">
      ...
      <li class="clearfix">
       <dd class="">
              市场价格：<font class="market">￥190元</font><br />
              
       本店售价：<font class="sell" id="ECS_SHOPPRICE">￥158元</font><br />
       <!--
              注册用户：<font class="shop" id="ECS_RANKPRICE_1">￥158元</font><br />
              vip：<font class="shop" id="ECS_RANKPRICE_2">￥150元</font><br />
              //-->
       </dd>
      ...
      <a href="javascript:addToCart(126)" class="add_to_cart_btn"></a>
      </div>
      </form>
     </div>
   </div>
   <div class="blank"></div>
     ...
     <div class="box_1">
      ...
      <div id="com_h">
       <blockquote>
        <p>产品尺寸：21cm**9cm*9cm包装尺寸：27cm*12.5cm*12cm材质：骨架为纤板+表面为竹纹皮电池信息：三节AA电池，AC/DC适配器，输入100&mdash;240VAC、50/60HZ，输出6VDC，输出电流500mA。</p>
<p>时间、日月、温度自动切换显示，声控及记忆功能随个人喜好调控。竹子造型和纹理将大自然的气息带进居室。</p>       </blockquote>
     <blockquote>
...
<script type="text/javascript" src="js/transport.js"></script><script type="text/javascript" src="js/utils.js"></script><div id="ECS_BOUGHT">554fcae493e564ee0dc75bdf2ebf94cabought_notes|a:2:{s:4:"name";s:12:"bought_notes";s:2:"id";i:126;}554fcae493e564ee0dc75bdf2ebf94ca</div>
  </div>
