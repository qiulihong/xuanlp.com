...
<title>创意方形可爱电子闹钟-23155_创意礼品_选礼品 - 专业礼品选购平台: 家居 小家电 粮油土特产 创意工艺品 办公用品</title>
...
<div class="block" style="border-bottom:1px solid #CB3F3F;">
 <div id="ur_here">
  <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=16">创意礼品</a> <code>&gt;</code> 创意方形可爱电子闹钟-23155 </div>
</div>
<div class="blank"></div>
...
document.getElementById('history_list').innerHTML = '您已清空最近浏览过的商品';
  ...
  <div class="AreaR">
   ...
   <div id="goodsInfo" class="clearfix">
     ...
     <div class="imgInfo">
          <a href="javascript:;" onclick="window.open('gallery.php?id=122'); return false;">
      <img src="images/201111/goods_img/122_G_1320274239806.jpg" alt="创意方形可爱电子闹钟-23155"/>
     </a>
              <div class="blank5"></div>
      ...
      <div class="gallery">
        <div id="demo">
          <div id="demo1" style="float:left">
            <ul>
                         <li><a href="gallery.php?id=122&amp;img=151" target="_blank"><img src="images/201111/thumb_img/122_thumb_P_1320274239843.jpg" alt="创意方形可爱电子闹钟-23155" class="B_blue" /></a>
            </li>
                        </ul>
          </div>
      ...
      function clickRight() {
         ...
         <div class="blank5"></div>
         <div>
		      <a href="javascript:collect(122)" class="collect"></a>
		      		      <a href="user.php?act=affiliate&goodsid=122" class="share"></a>
		               </div>
     ...
     <div class="clearfix">
      <p class="f_l">创意方形可爱电子闹钟-23155</p>
      <p class="f_r">
            <a href="goods.php?id=123"><img alt="prev" src="themes/default/images/up.gif" /></a>
                  <a href="goods.php?id=121"><img alt="next" src="themes/default/images/down.gif" /></a>
            </p>
      </div>
      <ul>
             <li class="clearfix">
      ...
      <li class="clearfix">
       <dd class="">
              市场价格：<font class="market">￥167元</font><br />
              
       本店售价：<font class="sell" id="ECS_SHOPPRICE">￥139元</font><br />
       <!--
              注册用户：<font class="shop" id="ECS_RANKPRICE_1">￥139元</font><br />
              vip：<font class="shop" id="ECS_RANKPRICE_2">￥132元</font><br />
              //-->
       </dd>
      ...
      <a href="javascript:addToCart(122)" class="add_to_cart_btn"></a>
      </div>
      </form>
     </div>
   </div>
   <div class="blank"></div>
     ...
     <div class="box_1">
      ...
      <div id="com_h">
       <blockquote>
        <p>产品尺寸：7cm*7cm*7cm包装尺寸：8*8*8cm材质：ABS产品内容：说明书</p>
<p>少见的正方形设计，贪睡功能的添加，精确你的睡眠时间，你想体验贪睡又不迟到吗？这款闹钟便可以帮你实现。</p>       </blockquote>
     <blockquote>
...
<script type="text/javascript" src="js/transport.js"></script><script type="text/javascript" src="js/utils.js"></script><div id="ECS_BOUGHT">554fcae493e564ee0dc75bdf2ebf94cabought_notes|a:2:{s:4:"name";s:12:"bought_notes";s:2:"id";i:122;}554fcae493e564ee0dc75bdf2ebf94ca</div>
  </div>
