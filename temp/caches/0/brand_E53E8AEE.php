...
<form name="selectPageForm" action="/brand.php" method="get">
 <div id="pager" class="pagebar">
  <span class="f_l f6" style="margin-right:10px;">总计 <b>24</b>  个记录</span>
                      ...
                      <a href="brand.php?id=12&amp;page=2&amp;sort=last_update&amp;order=DESC">[2]</a>
                      <a href="brand.php?id=12&amp;page=3&amp;sort=last_update&amp;order=DESC">[3]</a>
            
  <a class="next" href="brand.php?id=12&amp;page=2&amp;sort=last_update&amp;order=DESC">下一页</a>    </div>
</form>
<script type="Text/Javascript" language="JavaScript">
<!--
function selectPage(sel)
