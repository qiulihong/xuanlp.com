...
<title>果色生香系列多用途闹钟—橙子-25228_创意礼品_选礼品 - 专业礼品选购平台: 家居 小家电 粮油土特产 创意工艺品 办公用品</title>
...
<div class="block" style="border-bottom:1px solid #CB3F3F;">
 <div id="ur_here">
  <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=16">创意礼品</a> <code>&gt;</code> 果色生香系列多用途闹钟—橙子-25228 </div>
</div>
<div class="blank"></div>
...
document.getElementById('history_list').innerHTML = '您已清空最近浏览过的商品';
  ...
  <div class="AreaR">
   ...
   <div id="goodsInfo" class="clearfix">
     ...
     <div class="imgInfo">
          <a href="javascript:;" onclick="window.open('gallery.php?id=120'); return false;">
      <img src="images/201111/goods_img/120_G_1320273766982.jpg" alt="果色生香系列多用途闹钟—橙子-25228"/>
     </a>
              <div class="blank5"></div>
      ...
      <div class="gallery">
        <div id="demo">
          <div id="demo1" style="float:left">
            <ul>
                         <li><a href="gallery.php?id=120&amp;img=149" target="_blank"><img src="images/201111/thumb_img/120_thumb_P_1320273766756.jpg" alt="果色生香系列多用途闹钟—橙子-25228" class="B_blue" /></a>
            </li>
                        </ul>
          </div>
      ...
      function clickRight() {
         ...
         <div class="blank5"></div>
         <div>
		      <a href="javascript:collect(120)" class="collect"></a>
		      		      <a href="user.php?act=affiliate&goodsid=120" class="share"></a>
		               </div>
     ...
     <div class="clearfix">
      <p class="f_l">果色生香系列多用途闹钟—橙子-25228</p>
      <p class="f_r">
            <a href="goods.php?id=121"><img alt="prev" src="themes/default/images/up.gif" /></a>
                  <a href="goods.php?id=119"><img alt="next" src="themes/default/images/down.gif" /></a>
            </p>
      </div>
      <ul>
             <li class="clearfix">
      ...
      <a href="javascript:addToCart(120)" class="add_to_cart_btn"></a>
      </div>
      </form>
     </div>
   </div>
   <div class="blank"></div>
     ...
     <div class="box_1">
      ...
      <div id="com_h">
       <blockquote>
        <p>产品尺寸：直径9cm包装尺寸：10cm*10cm*4cm材质：塑料外壳,跳秒机芯</p>
...
<script type="text/javascript" src="js/transport.js"></script><script type="text/javascript" src="js/utils.js"></script><div id="ECS_BOUGHT">554fcae493e564ee0dc75bdf2ebf94cabought_notes|a:2:{s:4:"name";s:12:"bought_notes";s:2:"id";i:120;}554fcae493e564ee0dc75bdf2ebf94ca</div>
  </div>
