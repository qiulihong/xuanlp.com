...
document.getElementById('history_list').innerHTML = '您已清空最近浏览过的商品';
 ...
 <div class="box_1">
  ...
  <a href="category.php?category=1&display=grid&brand=0&price_min=220&price_max=240&filter_attr=0&page=1&sort=shop_price&order=DESC#goods_list"><img src="themes/default/images/shop_price_ASC.gif" alt="按价格排序"></a>
